...
class FeaturesFile(object):
	...
	def __init__(self, detector, extractor, keywords=None, root=os.path.dirname(__file__)+os.path.sep+"imm"+os.path.sep, estension=".jpg",flagKp=True):
	#def __init__(self, detector, extractor, keywords, root="./imm2/", estension=".jpg"):		
		...
		if detector== "HOG" and extractor == "HOG":
			...
			self.obj = detectAndExtract(detector,extractor,flagKp)
